...
export interface ExportService {
    exportDocuments(documents: WikiCatalog[], destination: string, progressCallback?: ProgressCallback): Promise<ExportResult>;
}
export interface MarkdownExporter {
    export(documents: WikiDocument[], destination: string, options?: MarkdownExportOptions): Promise<ExportResult>;
}
